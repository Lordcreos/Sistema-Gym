...
$target_dir = "images/";
	...
	mysqli_query($con,"update empresa set empresa='$empresa',ruc='$ruc',direccion='$direccion',telefono='$telefono',descripcion='$descripcion',imagen='$img',correo='$correo',por_dia='$por_dia',moneda='$moneda',simbolo_moneda='$simbolo_moneda',impuesto_diario='$impuesto_diario',impuesto_producto='$impuesto_producto',impuesto_planes='$impuesto_planes' where id_empresa='$id_empresa'")or die(mysqli_error());
	...
	mysqli_query($con,"update empresa set empresa='$empresa',ruc='$ruc',direccion='$direccion',telefono='$telefono',descripcion='$descripcion',correo='$correo',por_dia='$por_dia',moneda='$moneda',simbolo_moneda='$simbolo_moneda',impuesto_diario='$impuesto_diario',impuesto_producto='$impuesto_producto',impuesto_planes='$impuesto_planes' where id_empresa='$id_empresa'")or die(mysqli_error());
